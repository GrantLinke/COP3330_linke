...
public class TaskApp
{
    ...
    public static void displayFirstPrompt()
    {
        ...
        System.out.println("+----------------------+\n");
        System.out.println("1) Task List Application");
        System.out.println("2) Contact List Application");
        System.out.println("3) Quit");
        firstPromptInput();
    }

    private static void firstPromptInput()
    {
        int userIn = 3;
        try{
            while (true) {
    ...
    private static void firstPromptContinue(int userIn){
        switch (userIn)
        {
            case 1:
                displayMMPrompt();
